...
public class DivineDogWhiteRenderer extends MobRenderer<DivineDogWhiteEntity, DivineDogWhiteModel<DivineDogWhiteEntity>>
{
    protected static final ResourceLocation TEXTURE =
            new ResourceLocation(JJKMod.MOD_ID, "textures/entity/mob/divine_dog_white.png");

    public DivineDogWhiteRenderer(EntityRendererManager renderManagerIn) {
