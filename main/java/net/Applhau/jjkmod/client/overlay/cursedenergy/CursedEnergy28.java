...
public class CursedEnergy28 {

    protected static final ResourceLocation CURSEDENERGY = new ResourceLocation(JJKMod.MOD_ID + ":" + "/textures/overlay/cursedenergy_28.png");
