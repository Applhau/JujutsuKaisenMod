...
public class CursedEnergy23 {

    protected static final ResourceLocation CURSEDENERGY = new ResourceLocation(JJKMod.MOD_ID + ":" + "/textures/overlay/cursedenergy_23.png");
