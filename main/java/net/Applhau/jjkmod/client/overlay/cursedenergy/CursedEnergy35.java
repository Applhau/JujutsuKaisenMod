...
public class CursedEnergy35 {

    protected static final ResourceLocation CURSEDENERGY = new ResourceLocation(JJKMod.MOD_ID + ":" + "/textures/overlay/cursedenergy_35.png");
