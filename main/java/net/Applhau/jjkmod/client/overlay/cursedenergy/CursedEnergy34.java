...
public class CursedEnergy34 {

    protected static final ResourceLocation CURSEDENERGY = new ResourceLocation(JJKMod.MOD_ID + ":" + "/textures/overlay/cursedenergy_34.png");
