package net.Applhau.jjkmod.client.overlay.moveset.ratio;
...
public class RatioAbility1 {

    protected static final ResourceLocation ABILITYSET = new ResourceLocation(JJKMod.MOD_ID + ":" + "/textures/overlay/moveset/ratio_ability_selection.png");
    ...
    public static void eventHandler(RenderGameOverlayEvent.Post event) {
        if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
            ...
            if(Ability.ability == 0 && Ability.RatioTrig == true){
