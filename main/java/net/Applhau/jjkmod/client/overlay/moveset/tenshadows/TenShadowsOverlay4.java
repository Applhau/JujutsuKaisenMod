package net.Applhau.jjkmod.client.overlay.moveset.tenshadows;
...
public class TenShadowsOverlay4 {
    protected static final ResourceLocation ABILITYSET = new ResourceLocation(JJKMod.MOD_ID + ":" + "/textures/overlay/moveset/ten_shadows_moves.png");
    ...
    public static void eventHandler(RenderGameOverlayEvent.Post event) {
        if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
            ...
            if(Ability.ability == 3 && Ability.TenShadowsTrig == true){
                Minecraft.getInstance().getTextureManager().bindTexture(ABILITYSELECTOR);
                Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + -163, posY + 77, 0, 0, 16, 16, 16, 16);
