...
public class Ratio01Particle extends SpriteTexturedParticle {
    protected Ratio01Particle(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ) {
