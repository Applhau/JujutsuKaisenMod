...
public class AddSpeed {
    ...
    public static void handle(AddSpeed message, Supplier<NetworkEvent.Context> contextSupplier) {
        ...
        context.enqueueWork(() -> {
            ...
            double a = (double) StatGuiScreen.spd / 50;

            AttributeModifier speed = new AttributeModifier(UUID.fromString("4aadd9c0-cb9a-11ec-9d64-0242ac120002"), "player_speed", 0.1D + a, AttributeModifier.Operation.ADDITION);
