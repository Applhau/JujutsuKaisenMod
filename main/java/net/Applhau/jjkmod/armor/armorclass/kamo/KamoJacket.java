...
import net.Applhau.jjkmod.armor.models.kamojacket;
...
public class KamoJacket extends ArmorItem {

    net.Applhau.jjkmod.armor.models.kamojacket kamojacket = new kamojacket();

    public KamoJacket(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedBody = new kamojacket().body;
            armorModel.bipedLeftArm = new kamojacket().leftarm;
            armorModel.bipedRightArm = new kamojacket().rightarm;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/kamo_jacket1.png";
    }
}
