package net.Applhau.jjkmod.armor.armorclass.shoko;
...
public class ShokoTOp extends ArmorItem {

    net.Applhau.jjkmod.armor.models.femalebody body = new femalebody();

    public ShokoTOp(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/shoko_jacket.png";
    }
