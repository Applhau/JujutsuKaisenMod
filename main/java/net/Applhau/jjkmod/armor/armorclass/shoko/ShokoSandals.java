...
public class ShokoSandals extends ArmorItem {

    net.Applhau.jjkmod.armor.models.shoes shoes = new shoes();

    public ShokoSandals(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/shoko_shoes.png";
    }
}
