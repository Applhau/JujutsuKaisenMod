...
public class TokyoBodyLegs extends ArmorItem {

    net.Applhau.jjkmod.armor.models.pants pants = new pants();

    public TokyoBodyLegs(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/tokyo_male_pants.png";
    }
}
