package net.Applhau.jjkmod.armor.armorclass.tokyooutfit;
...
public class TokyoFemaleJacket extends ArmorItem {

    net.Applhau.jjkmod.armor.models.femalebody body = new femalebody();

    public TokyoFemaleJacket(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedBody = new femalebody().body;
            armorModel.bipedLeftArm = new femalebody().leftarm;
            armorModel.bipedRightArm = new femalebody().rightarm;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/tokyo_female_jacket.png";
    }
