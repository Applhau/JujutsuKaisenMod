...
public class TokyoFemaleSkirt extends ArmorItem {

    net.Applhau.jjkmod.armor.models.pants pants = new pants();

    public TokyoFemaleSkirt(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedRightLeg = new pants().rightleg;
            armorModel.bipedLeftLeg = new pants().leftleg;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/tokyo_female_pants.png";
    }
}
