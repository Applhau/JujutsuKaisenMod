...
public class TokyoBoyOutfit extends ArmorItem {

    net.Applhau.jjkmod.armor.models.body body = new body();

    public TokyoBoyOutfit(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedBody = new body().body;
            armorModel.bipedLeftArm = new body().leftarm;
            armorModel.bipedRightArm = new body().rightarm;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/tokyo_male_jacket.png";
    }
