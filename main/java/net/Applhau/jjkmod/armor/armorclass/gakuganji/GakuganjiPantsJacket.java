...
import net.Applhau.jjkmod.armor.models.gakuganjijacketpants;
...
public class GakuganjiPantsJacket extends ArmorItem {

    net.Applhau.jjkmod.armor.models.gakuganjijacketpants gakuganjijacketpants = new gakuganjijacketpants();

    public GakuganjiPantsJacket(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedRightLeg = new gakuganjijacketpants().rightleg;
            armorModel.bipedLeftLeg = new gakuganjijacketpants().leftleg;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/gakuganji_jacket_pants3.png";
    }
}
