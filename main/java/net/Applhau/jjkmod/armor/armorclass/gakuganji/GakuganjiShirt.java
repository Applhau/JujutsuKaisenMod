...
public class GakuganjiShirt extends ArmorItem {

    net.Applhau.jjkmod.armor.models.body body = new body();

    public GakuganjiShirt(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/gakuganji_shirt5.png";
    }
}
