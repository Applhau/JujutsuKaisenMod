...
import net.Applhau.jjkmod.armor.models.chosofeet;
...
public class ChosoSHoes extends ArmorItem {

    net.Applhau.jjkmod.armor.models.chosofeet chosofeet = new chosofeet();

    public ChosoSHoes(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedRightLeg = new chosofeet().rightshoes;
            armorModel.bipedLeftLeg = new chosofeet().leftshoes;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/chosofeet.png";
    }
}