package net.Applhau.jjkmod.armor.armorclass.choso;

import net.Applhau.jjkmod.JJKMod;
import net.Applhau.jjkmod.armor.models.chosopants;
...
public class ChosoPants extends ArmorItem {

    net.Applhau.jjkmod.armor.models.chosopants chosopants = new chosopants();

    public ChosoPants(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedRightLeg = new chosopants().rightleg;
            armorModel.bipedLeftLeg = new chosopants().leftleg;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/chosopants.png";
    }
}