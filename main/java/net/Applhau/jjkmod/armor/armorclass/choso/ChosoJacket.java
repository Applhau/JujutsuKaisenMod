...
public class ChosoJacket  extends ArmorItem {

    net.Applhau.jjkmod.armor.models.chosorobe chosorobe = new chosorobe();

    public ChosoJacket(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedBody = new chosorobe().body;
            armorModel.bipedLeftArm = new chosorobe().leftarm;
            armorModel.bipedRightArm = new chosorobe().rightarm;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/chososhirt.png";
    }
}
