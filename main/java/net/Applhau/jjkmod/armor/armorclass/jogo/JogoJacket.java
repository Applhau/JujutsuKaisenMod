package net.Applhau.jjkmod.armor.armorclass.jogo;

import net.Applhau.jjkmod.JJKMod;
import net.Applhau.jjkmod.armor.models.body;
import net.Applhau.jjkmod.armor.models.jogojacket;
...
public class JogoJacket extends ArmorItem {

    net.Applhau.jjkmod.armor.models.jogojacket jogojacket = new jogojacket();

    public JogoJacket(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedBody = new jogojacket().body;
            armorModel.bipedLeftArm = new jogojacket().leftarm;
            armorModel.bipedRightArm = new jogojacket().rightarm;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/jogoshirt.png";
    }
}
