...
import net.Applhau.jjkmod.armor.models.ioripants;
...
public class IoriPants extends ArmorItem {

    net.Applhau.jjkmod.armor.models.ioripants ioripants = new ioripants();

    public IoriPants(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedRightLeg = new ioripants().rightleg;
            armorModel.bipedLeftLeg = new ioripants().leftleg;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/iori_pants.png";
    }
}
