package net.Applhau.jjkmod.armor.armorclass.yuta;
...
public class YutaJacket extends ArmorItem {

    net.Applhau.jjkmod.armor.models.body body = new body();

    public YutaJacket(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/yuta_jacket.png";
    }
}
