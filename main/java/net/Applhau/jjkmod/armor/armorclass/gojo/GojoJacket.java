...
public class GojoJacket  extends ArmorItem {

    net.Applhau.jjkmod.armor.models.body body = new body();

    public GojoJacket(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/gojo_jacket.png";
    }
}
