...
import net.Applhau.jjkmod.armor.models.mahitoshoes;
...
public class MahitoShoes extends ArmorItem {

    net.Applhau.jjkmod.armor.models.mahitoshoes mahitoshoes = new mahitoshoes();

    public MahitoShoes(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedRightLeg = new mahitoshoes().rightshoes;
            armorModel.bipedLeftLeg = new mahitoshoes().leftshoes;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/mahito_shoes.png";
    }
}
