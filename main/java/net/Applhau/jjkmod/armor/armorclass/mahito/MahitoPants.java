...
import net.Applhau.jjkmod.armor.models.mahitopants;
...
public class MahitoPants extends ArmorItem {

    net.Applhau.jjkmod.armor.models.mahitopants mahitopants = new mahitopants();

    public MahitoPants(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedRightLeg = new mahitopants().rightleg;
            armorModel.bipedLeftLeg = new mahitopants().leftleg;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/mahito_pants.png";
    }
}
