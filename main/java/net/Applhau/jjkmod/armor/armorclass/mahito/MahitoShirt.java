package net.Applhau.jjkmod.armor.armorclass.mahito;

import net.Applhau.jjkmod.JJKMod;
import net.Applhau.jjkmod.armor.models.body;
import net.Applhau.jjkmod.armor.models.mahitoshirt;
...
public class MahitoShirt extends ArmorItem {

    net.Applhau.jjkmod.armor.models.mahitoshirt mahitoshirt = new mahitoshirt();

    public MahitoShirt(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedBody = new mahitoshirt().body;
            armorModel.bipedLeftArm = new mahitoshirt().leftarm;
            armorModel.bipedRightArm = new mahitoshirt().rightarm;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/mahito_shirt.png";
    }
}
