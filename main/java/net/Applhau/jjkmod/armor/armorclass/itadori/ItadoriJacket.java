package net.Applhau.jjkmod.armor.armorclass.itadori;
...
public class ItadoriJacket extends ArmorItem {

    net.Applhau.jjkmod.armor.models.body body = new body();

    public ItadoriJacket(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/itadori_jacket.png";
    }
}
