...
public class SuitPants extends ArmorItem {

    net.Applhau.jjkmod.armor.models.pants pants = new pants();

    public SuitPants(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/suit_pants.png";
    }
}
