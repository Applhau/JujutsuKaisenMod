...
public class SuitShoes extends ArmorItem {

    net.Applhau.jjkmod.armor.models.shoes shoes = new shoes();

    public SuitShoes(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/suit_shoes.png";
    }
}
