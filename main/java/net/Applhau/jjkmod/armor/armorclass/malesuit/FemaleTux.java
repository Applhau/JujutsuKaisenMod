...
public class FemaleTux extends ArmorItem {

    net.Applhau.jjkmod.armor.models.femalebody body = new femalebody();

    public FemaleTux(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/female_tux.png";
    }
