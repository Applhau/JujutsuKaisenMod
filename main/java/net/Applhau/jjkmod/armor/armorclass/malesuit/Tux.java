package net.Applhau.jjkmod.armor.armorclass.malesuit;
...
public class Tux extends ArmorItem {

    net.Applhau.jjkmod.armor.models.body body = new body();

    public Tux(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/tux.png";
    }
}
