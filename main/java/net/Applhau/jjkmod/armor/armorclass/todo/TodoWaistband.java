...
import net.Applhau.jjkmod.armor.models.femalebody;
import net.Applhau.jjkmod.armor.models.todowaistband;
...
public class TodoWaistband extends ArmorItem {

    net.Applhau.jjkmod.armor.models.todowaistband todowaistband = new todowaistband();

    public TodoWaistband(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedBody = new todowaistband().body;
            armorModel.bipedLeftArm = new todowaistband().leftarm;
            armorModel.bipedRightArm = new todowaistband().rightarm;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/todowaistband.png";
    }
