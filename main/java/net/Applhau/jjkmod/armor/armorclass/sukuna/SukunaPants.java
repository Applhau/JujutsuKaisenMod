...
public class SukunaPants extends ArmorItem {

    net.Applhau.jjkmod.armor.models.chosopants chosopants = new chosopants();

    public SukunaPants(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builderIn) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/sukunapants.png";
    }
}