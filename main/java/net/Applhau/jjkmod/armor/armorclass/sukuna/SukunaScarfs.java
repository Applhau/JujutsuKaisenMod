...
import net.Applhau.jjkmod.armor.models.chososcarf;
import net.Applhau.jjkmod.armor.models.sukunascarf;
...
public class SukunaScarfs extends ArmorItem {


    net.Applhau.jjkmod.armor.models.sukunascarf chososcarf = new sukunascarf();

    public SukunaScarfs(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
    ...
    public BipedModel getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, BipedModel original) {
        ...
        if (armorModel != null) {
            ...
            armorModel.bipedHeadwear = new chososcarf().Head;
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        ...
        return JJKMod.MOD_ID + ":" + "/textures/models/armor/sukunascarf.png";
    }
}
