...
public class gakuganjijacketpants extends BipedModel<LivingEntity> {
    public final ModelRenderer rightleg;
    public final ModelRenderer leftleg;

    public gakuganjijacketpants() {
        super(64);
        textureWidth = 64;
        textureHeight = 64;
        ...
        rightleg.setTextureOffset(48, 50).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 10.0F, 4.0F, 0.3F, false);

        leftleg = new ModelRenderer(this);
        leftleg.setRotationPoint(1.9F, 12.0F, 0.0F);
        leftleg.setTextureOffset(0, 33).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 10.0F, 4.0F, 0.1F, true);
        leftleg.setTextureOffset(48, 0).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 10.0F, 4.0F, 0.3F, false);
