...
public class BloodManipulationToken extends Item {
    public BloodManipulationToken(Properties properties) {
        super(properties);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        Ability.CursedSpeechTrig = false;
        Ability.ConstructionTrig= false;
        Ability.BloodManipulationTrig= true;
